...
public class PoemClient {
    ...
    private static void readPoem() {
        ...
        try {
            ...
            reader = new BufferedReader(new FileReader("Lab12.1/famous-poem.txt"));
        ...
        private static void writePoem () {
            ...
            try{
                writer = new PrintWriter(new BufferedWriter(
                        new FileWriter("Lab12.1/haiku.txt")));
                writer.println("Writing this is tough");
                writer.println("Poetry is not for me");
                writer.println("I would rather code");
